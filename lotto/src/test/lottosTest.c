...
TEST(lottosTest, set_ranking)
{
	...
	set_ranking(lottos, ranking, correct_numbers);

	TEST_ASSERT_EQUAL(ranking[0], 0);
	TEST_ASSERT_EQUAL(ranking[1], 0);
	TEST_ASSERT_EQUAL(ranking[2], 0);
	TEST_ASSERT_EQUAL(ranking[3], 2);
	TEST_ASSERT_EQUAL(ranking[4], 0);
	TEST_ASSERT_EQUAL(ranking[5], 0);
	TEST_ASSERT_EQUAL(ranking[6], 1);
}
